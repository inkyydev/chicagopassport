    ...
    <section id="why_choose">
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-12 col-md-6">
            <div className="why-choose-faq">
              {features.map((item, index) => (
                <div
                  className={`why-choose-faq__single ${
                    activeIndex === index ? "active" : ""
                  }`}
                  onClick={() => setActiveIndex(index)}
                  key={index}
                >
                  <div className="why-choose-faq__single--title">
                    <div className="why-choose-faq__single--title--icon">
                      {item.icon}
                    </div>
                    <div className="why-choose-faq__single--title--text">
                      <h3>{item.title}</h3>
                    </div>
                  </div>
                  <div className="why-choose-faq__single--description">
